...
public class FeaturedCollectionsContract {
    ...
    public static class PresenterImpl extends ContentPresenter<View> implements Presenter {
        ...
        public String getTag() {
            return LogUtils.getLogTag(FeaturedCollectionsContract.PresenterImpl.class);
        }

        @Override
        public ContentCache getContentCache() {
            return getDataManager().getFeaturedCollectionsCache();
        }
    }
}
